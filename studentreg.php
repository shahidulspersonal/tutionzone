...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = mysqli_query($conn, "INSERT INTO `student`(name, email, password, image) VALUES('$name', '$email', '$pass', '$image')") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>already have an account? <a href="studentlogin.php">login now</a></p>
   </form>
